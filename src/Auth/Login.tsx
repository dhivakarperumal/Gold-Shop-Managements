      ...
      <div className="w-[380px] bg-white border border-gray-200 shadow-xl rounded-2xl px-6 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-2.5 px-4 border border-gray-300 rounded-lg bg-white text-gray-700 font-medium hover:bg-gray-50 flex items-center justify-center gap-2 transition-all shadow-sm"
          >
